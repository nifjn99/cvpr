    ...
    while True:
        ...
        for phase, phase_gen_z, phase_gen_c in zip(phases, all_gen_z, all_gen_c):
            ...
            for round_idx, (real_img, real_c, gen_z, gen_c, real_img_feature, real_txt_feature) in enumerate(zip(phase_real_img, phase_real_c, phase_gen_z, phase_gen_c, phase_img_features, phase_txt_features)):
                ...
                loss.accumulate_gradients_noise09(phase=phase.name, real_img=real_img, real_c=real_c, gen_z=gen_z, gen_c=gen_c, sync=sync, gain=gain, img_fts=real_img_feature, txt_fts=real_txt_feature, mixing_prob=mixing_prob, temp=temp, lam=lam, gather=gather, d_use_fts=d_use_fts, itd=itd, itc=itc, iid=iid, iic=iic)
